...
func (s *serviceGrpcImpl) SignUp(ctx context.Context, in *accounts.AccountCreds) (*common.EmptyMessage, error) {
	logger.EnpointHit(ctx)
	return SignUp(ctx, in)
}

func (s *serviceGrpcImpl) SignIn(ctx context.Context, in *accounts.AccountCreds) (*common.EmptyMessage, error) {
	logger.EnpointHit(ctx)
